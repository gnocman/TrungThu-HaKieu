...
const wishList = [
  {
    text: "Chúc em một đêm Trung Thu thật vui, thật ấm áp và luôn có những người khiến em mỉm cười.",
    img: "./assets/1.jpg",
  },

  {
    text: "Mong đêm trăng này mang đến cho em thật nhiều niềm vui, còn một chút dễ thương thì để anh lo.",
    img: "./assets/2.jpg",
  },

  {
    text: "Trăng hôm nay chắc sẽ rất đẹp, nhưng có lẽ vẫn chưa đẹp bằng nụ cười của em.",
    img: "./assets/3.jpg",
  },
